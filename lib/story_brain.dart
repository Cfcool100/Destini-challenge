...
class StoryBrain {
  ...
  nextStory(int userChoice) {
    int choiceN = userChoice;

    if (choiceN == 1 && _index == 0) {
      _index = 2; // Q3
    } else if (choiceN == 2 && _index == 0) {
      _index = 1; //Q2
    } else if (choiceN == 1 && _index == 1) {
      _index = 2; //Q3
    } else if (choiceN == 2 && _index == 1) {
      _index = 3; //Q4
    } else if (choiceN == 1 && _index == 2) {
      _index = 5; //Q6
    } else if (choiceN == 2 && _index == 2) {
      _index = 4; //Q5
